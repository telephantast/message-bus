...
final readonly class Dispatcher
{
     ...
     */
    public function invoke(Envelope $method, EnvelopeFactory $envelopeFactory, ?Context $parentContext = null): mixed
    {
        return $this->services[$this->methodRouter->route($method->messageClass)]->invoke($method, $parentContext, $envelopeFactory, $this);
    }
}
